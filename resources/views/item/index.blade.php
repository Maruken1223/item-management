    ...
    <div class="col-12">
        ...
        <div class="row">
            <h1 class="col justify-content-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
            ...
            <form method="GET" class="d-flex" action="{{ route('itemindex') }}">
